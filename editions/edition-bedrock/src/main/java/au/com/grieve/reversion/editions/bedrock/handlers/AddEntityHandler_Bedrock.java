...
public class AddEntityHandler_Bedrock extends PacketHandler<BedrockTranslator, AddEntityPacket> {
    public static final AddEntityHandler_Bedrock INSTANCE = new AddEntityHandler_Bedrock();

    @Override
    public boolean fromDownstream(BedrockTranslator translator, AddEntityPacket packet) {
        ...
        entity = translator.getEntityMapper().addEntityToUpstream(entity);
