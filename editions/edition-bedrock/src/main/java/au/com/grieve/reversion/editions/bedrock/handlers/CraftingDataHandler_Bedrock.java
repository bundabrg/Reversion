...
public class CraftingDataHandler_Bedrock extends PacketHandler<BedrockTranslator, CraftingDataPacket> {
    public static final CraftingDataHandler_Bedrock INSTANCE = new CraftingDataHandler_Bedrock();

    @Override
    public boolean fromDownstream(BedrockTranslator translator, CraftingDataPacket packet) {
