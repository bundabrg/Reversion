...
public class CreativeContentHandler_Bedrock extends PacketHandler<BedrockTranslator, CreativeContentPacket> {
    public static final CreativeContentHandler_Bedrock INSTANCE = new CreativeContentHandler_Bedrock();
    ...
    public boolean fromDownstream(BedrockTranslator translator, CreativeContentPacket packet) {
        ...
        for (ItemData item : packet.getContents()) {
            ItemData translatedItem = translator.getItemMapper().mapItemDataToUpstream(item);
