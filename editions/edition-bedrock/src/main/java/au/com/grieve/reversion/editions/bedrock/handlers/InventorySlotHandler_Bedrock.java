...
public class InventorySlotHandler_Bedrock extends PacketHandler<BedrockTranslator, InventorySlotPacket> {
    public static final InventorySlotHandler_Bedrock INSTANCE = new InventorySlotHandler_Bedrock();

    @Override
    public boolean fromDownstream(BedrockTranslator translator, InventorySlotPacket packet) {
