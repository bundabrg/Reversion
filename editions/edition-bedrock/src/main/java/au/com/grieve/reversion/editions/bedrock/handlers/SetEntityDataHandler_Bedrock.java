...
public class SetEntityDataHandler_Bedrock extends PacketHandler<BedrockTranslator, SetEntityDataPacket> {
    public static final SetEntityDataHandler_Bedrock INSTANCE = new SetEntityDataHandler_Bedrock();

    @Override
    public boolean fromDownstream(BedrockTranslator translator, SetEntityDataPacket packet) {
        ...
        entity = translator.getEntityMapper().mapEntitytoUpstream(entity);
