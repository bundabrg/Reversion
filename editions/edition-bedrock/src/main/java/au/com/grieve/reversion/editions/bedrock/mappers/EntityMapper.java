...
public class EntityMapper {
    public static EntityMapper DEFAULT = new EntityMapper();
    ...
    public Entity addEntityToUpstream(Entity original) {
        if (original == null) {
            return null;
        }
        ...
        Entity translated = mapEntitytoUpstream(original);

        return translated;
    }

    public Entity mapEntitytoUpstream(Entity original) {
        if (original == null) {
            return null;
        }
    ...
    public void removeEntityToUpstream(Entity original) {
