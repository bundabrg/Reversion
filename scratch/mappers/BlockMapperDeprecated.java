...
public class BlockMapperDeprecated {
    public static final BlockMapperDeprecated DEFAULT = new BlockMapperDeprecated();

    private final Map<String, List<MapConfig>> mapList = new HashMap<>();
    private final Map<Integer, Short> nameToIdMap = new HashMap<>();
    int version;

    public BlockMapperDeprecated(InputStream mapStream, InputStream runtimeStatesStream) throws MapperException {
