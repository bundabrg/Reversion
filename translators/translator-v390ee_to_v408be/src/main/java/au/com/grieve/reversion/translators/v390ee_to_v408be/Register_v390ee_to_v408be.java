...
public class Register_v390ee_to_v408be {
    public static RegisteredTranslator TRANSLATOR = RegisteredTranslator.builder()
            ...
            .registerPacketHandler(CreativeContentPacket.class, CreativeContentHandler_v390ee_to_v408be.INSTANCE)
            ...
            .registerPacketHandler(StartGamePacket.class, StartGameHandler_Education.INSTANCE)
            .build();
}
